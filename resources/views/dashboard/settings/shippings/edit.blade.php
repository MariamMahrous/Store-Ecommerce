...
@section('content')
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                               ...
                               <li class="breadcrumb-item"><a href="">{{__('messages.home')}} </a>
                                ...
                                <li class="breadcrumb-item active"> {{__('messages.shipping')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">     {{__('messages.edit_shipping')}}  </h4>
   ...
   <div class="col-md-6 ">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{__('messages.value')}} </label>
                                                            <input type="text" id="plain_value"
                                                                   class="form-control"
