                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.maincategories')}}">  {{__('messages.mainCategories')}}  </a>
                                </li>
                                <li class="breadcrumb-item active"> {{__('messages.edit')}}  - {{$mainCategory-> name}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">   {{__('messages.editMainCategory')}}  </h4>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1"
                                                                   ...
                                                                   @if( $mainCategory->is_active)checked  @endif/>
