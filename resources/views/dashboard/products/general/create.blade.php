                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> {{ __('messages.add_product') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{ __('messages.add_product') }} </h4>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{ __('messages.product_name') }}
                                                            </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{ __('messages.slug') }}
                                                            </label>
                                                ...
                                                {{-- begin description row --}}
                                                 ...
                                                 <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{ __('messages.description') }}
                                                            </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{ __('messages.short_description') }}
                                                            </label>
                                                ...
                                                {{-- begin select Main Catgeory if choose sub category Radio Buuton --}}

                                                <div class="row ">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projectinput2"> {{ __('messages.choose_category') }}
                                                            </label>
                                                            <select class="select2 form-control" name="categories[]" multiple>
                                                                <optgroup label="{{ __('messages.Pselectcategory') }} ">
                                                                </optgroup>
                                                ...
                                                {{-- begin tags --}}
                                                  <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projectinput2"> {{ __('messages.choose_tag') }}
                                                            </label>
                                                ...
                                                {{-- Begin brands --}}
                                                  <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projectinput2"> {{ __('messages.choose_brand') }}
                                                            </label>
                                                            <select class="select form-control" name="brand_id">
                                                                <optgroup label="{{ __('messages.Pselectcategory') }} ">
                                                                </optgroup>
                                                ...
                                                {{-- end select Main Catgeory if choose sub category Radio Buuton --}}
