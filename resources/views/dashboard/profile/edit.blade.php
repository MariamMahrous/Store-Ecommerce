                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                               ...
                               <li class="breadcrumb-item"><a href="">{{__('messages.home')}} </a>
                                ...
                                <li class="breadcrumb-item active"> {{__('messages.profile')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">     {{__('messages.edit_profile')}}  </h4>
                                           ...
                                           @method('PUT')
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                     <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{__('messages.name')}} </label>
                                              ...
                                              <div class="col-md-6 ">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{__('messages.email')}} </label>
                                              ...
                                              <div class="col-md-6 ">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{__('messages.password_confirmation')}} </label>
